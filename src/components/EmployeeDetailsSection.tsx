...
import { User as UserType, EmployeeProgress, PerformanceIndicator } from '@/types';
...
const EmployeeDetailsSection: React.FC<EmployeeDetailsSectionProps> = ({
  ...
  const getStatusIcon = (progress: EmployeeProgress, indicator: PerformanceIndicator) => {
  ...
  const getStatusBadge = (progress: EmployeeProgress, indicator: PerformanceIndicator) => {
    const isCompleted = progress.currentValue >= indicator.maxValue;
  ...
  return (
    <div className="space-y-6 mt-6 border-t pt-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-slate-800">Detalles del Empleado</h2>
